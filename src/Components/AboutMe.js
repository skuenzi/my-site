...
// import climbingpic from '../../Images/climbing.jpg'

export default function AboutMe () {
    const [readMore, setReadMore] = useState(false)

    const aboutMeInfo = `
    I've dabbled in many career fields, but programming has kept my attention more than anything else! I started my journey in 2019 with a course called Watch and Code, then continued on to finish a Frontend Developer Career Path with Scrimba. These programs took me through courses on Vanilla Javascript, HTML, and CSS for the basics, then onto React. Learning React is where I really started feeling comfortable in programming and I love using it to build reusable components that can be tailored to any web app. Although CSS has taken a bit more effort for me to feel comfortable with, I've learned to appreciate the possibilities of Flexbox and Grid.
